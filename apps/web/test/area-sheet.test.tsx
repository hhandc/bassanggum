...
describe('AreaSheet', () => {
  it('shows a selected named bounty zone and its invasive species', () => {
    ...
    ], restricted: false, joined: false }} locale="en" onJoin={() => undefined} />);
  ...
  it('does not offer bounty participation in a restricted area', () => {
    render(<AreaSheet area={{ id: 'restricted:area', name: 'Protected wetland', kind: 'protected area', topSpecies: [], restricted: true, joined: false }} locale="en" onJoin={() => undefined} />);
