...
SHP checksum. User-confirmed permission allows reuse of the supplied KDPA
...
over `features`. `sourceFileChecksum` is the SHA-256 digest of the unmodified
