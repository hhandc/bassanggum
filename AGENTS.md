...
### Stack
- Language and version: TypeScript 5.9.3
- Framework(s): Model Context Protocol SDK; h3-js
- Package manager: pnpm 11.19.0
- Runtime / deployment target: Node.js >=22
...
### Layout
- Source lives in: `.worktrees/bassanggum/packages/*/src`
- Tests live in: `.worktrees/bassanggum/packages/*/test`
